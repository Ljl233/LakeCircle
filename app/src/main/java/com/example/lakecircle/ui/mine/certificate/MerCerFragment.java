...
public class MerCerFragment extends Fragment {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        Log.e("RequestPermissionResult", requestCode+"  "+grantResults[0]);
        switch (requestCode) {
    ...
    private void compressImage( ) {
        ...
        ImageUtils.compressImage(getContext(), originalImage, targetDir, new OnCompressListener() {
            @Override
            public void onStart() {Log.e("MerCerFragment", "start compress image"); }
            ...
            public void onError(Throwable e) {
                e.printStackTrace();
                Log.e("MerCerFragment", "compress image fail");
                showError("图片压缩失败");
            }
        });
    }

    private void postMerCer(File file) {
